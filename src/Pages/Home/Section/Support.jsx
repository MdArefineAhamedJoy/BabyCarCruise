...
const Support = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 my-10 ">
      <div className="text-center relative p-8 py-10 border-4 bg-slate-100 hover:shadow-md hover:border-sky-400 ">
      ...
      <div className="text-center relative p-8 py-10 border-4 bg-slate-100 hover:border-sky-400 hover:shadow-md">
      ...
      <div className="relative text-center p-8 py-10 border-4 bg-slate-100 hover:shadow-md hover:border-sky-400">
